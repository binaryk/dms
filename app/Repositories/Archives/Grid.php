...
class Grid extends \App\Comptechsoft\Datatable\Grid
{
	...
	public function __construct()
	{
		 ...
		 */
		$this->js( str_replace('\\', '/', public_path('custom/js/archives/grid.js') ));
		/*
		...
		$this->addColumns([
			...
			'description' =>
				(new Column())
					->withHeader(
						(new Header())
							->with(['caption' => 'Descriere', 'width' => 35])
	...
	public function setUrl()
	{
		 ...
		 */
		$this->ajax( (new Ajax())->setUrl(\URL::route('archives.data-source'))->setExtra(['a' => 1, 'b' => 2]) );
		return $this;
	}
}