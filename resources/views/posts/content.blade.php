<div class="col-lg-9">
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg1.jpg')!!}" class="img-responsive">
                </a>
            ...
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg10.jpg')!!}" class="img-responsive">
                </a>
                <div class="panel-body">
                    <p class="clearfix">
                                 <span class="pull-left">
        ...
        <div class="col-lg-4">
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg2.jpg')!!}" class="img-responsive">
                </a>
                <div class="panel-body">
                    <p class="clearfix">
                                 <span class="pull-left">
            ...
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg8.jpg')!!}" class="img-responsive">
                </a>
                <div class="panel-body">
                    <p class="clearfix">
                                 <span class="pull-left">
        ...
        <div class="col-lg-4">
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg3.jpg')!!}" class="img-responsive">
                </a>
                <div class="panel-body">
                    <p class="clearfix">
                                 <span class="pull-left">
            ...
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg4.jpg')!!}" class="img-responsive">
                </a>
                <div class="panel-body">
                    <p class="clearfix">
                                 <span class="pull-left">
            ...
            <div class="panel">
                <a href="">
                    <img src="{!! asset('angel/img/bg5.jpg')!!}" class="img-responsive">
                </a>
                <div class="panel-body">
                    <p class="clearfix">
                                 <span class="pull-left">
...
<div class="col-lg-3">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <a href="">
                <img src="{!! asset('angel/img/mockup.png')!!}" class="img-responsive img-thumbnail">
            </a>
        </div>
    </div>
</div>
